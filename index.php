				...
				<div class="tp-hero-active swiper-container">
					<div class="swiper-wrapper">
						<div class="swiper-slide pt-160 pb-115" data-bg-color="#16243E">
							<div class="tp-hero-bg" data-background="uss-modules/uss-bank/bank-home/assets/img/hero/shape-bg.png">
							</div>
							<div class="container">
								<div class="row">
									<div class="col-lg-7">
											...
											<div class="tp-hero-button-wrapper d-flex flex-wrap align-items-center">
												...
												<div class="tp-hero-call d-flex align-items-center">
													<span>
														<svg width="37" height="36" viewBox="0 0 37 36" fill="none"
															...
															<path
																...
																stroke="url(#paint0_linear_3043_11)" stroke-width="2.10938" stroke-miterlimit="10"
															...
															<path
																...
																stroke="url(#paint1_linear_3043_11)" stroke-width="2.10938" stroke-miterlimit="10"
																stroke-linecap="round" stroke-linejoin="round" />
															<path
																...
																stroke="url(#paint2_linear_3043_11)" stroke-width="2.10938" stroke-miterlimit="10"
																stroke-linecap="round" stroke-linejoin="round" />
															<defs>
																<linearGradient id="paint0_linear_3043_11" x1="18.9453" y1="11.5808" x2="29.6887"
																	y2="11.5808" gradientUnits="userSpaceOnUse">
																	<stop stop-color="#004D6E" />
																	<stop offset="1" stop-color="#00ACCC" />
																</linearGradient>
																<linearGradient id="paint1_linear_3043_11" x1="2" y1="19.1953" x2="33.5" y2="19.1953"
													...
													<div class="tp-hero-call-inner">
														<p>Need help?</p>
														<span><a href="tel:7156006612">7156006612</a></span>
													</div>
												</div>
											</div>
										</div>
									...
									<div class="col-lg-5">
										<div class="tp-hero-thumb p-relative">
											<div class="tp-hero-thumb-shape">
												<img class="shape-1" src="uss-modules/uss-bank/bank-home/assets/img/hero/shape-2.png" alt="">
												<img class="shape-2" src="uss-modules/uss-bank/bank-home/assets/img/hero/shape-1.png" alt="">
												<img class="shape-3" src="uss-modules/uss-bank/bank-home/assets/img/hero/shape-1.png" alt="">
											</div>
				...
				<div class="row">
					...
					<div class="col-lg-6">
						<div class="tp-about-wrapper">
							...
							<p>Find out what to look out for when transacting online and how we keep you safe. Find practical
								tips and guidelines for safe trading.</p>
							...
							<div class="tp-about-btn">
								<a href="login" class="tp-btn">Sign in now</a>
							</div>
						</div>
					</div>
				</div>
								...
								<div class="tp-service-item-wrapper p-relative">
									...
									<div class="tp-service-item-thumb">
										<a href="service-details.html"><img
												src="uss-modules/uss-bank/bank-home/assets/img/service/img-1.jpg" alt=""></a>
									</div>
								</div>
							</div>
							<div class="swiper-slide">
								<div class="tp-service-item-wrapper p-relative">
									...
									<div class="tp-service-item-thumb">
										<a href="service-details.html"><img
												src="uss-modules/uss-bank/bank-home/assets/img/service/img-2.jpg" alt=""></a>
									</div>
								</div>
							</div>
							<div class="swiper-slide">
								<div class="tp-service-item-wrapper p-relative">
									...
									<div class="tp-service-item-thumb">
										<a href="service-details.html"><img
												src="uss-modules/uss-bank/bank-home/assets/img/service/img-3.jpg" alt=""></a>
									</div>
								</div>
							</div>
						</div>
						...
						<div class="tp-process-wrapper">
							...
							<div class="tp-process-item d-flex align-items-center">
								...
								<div class="tp-process-item-content">
									...
									<p>We offer easy to use accounts that are designed exclusively to meet your business needs.
										One of our Business Bankers or customer service specialists can help you find the right
										one for you.</p>
								</div>
							</div>
							<div class="tp-process-item d-flex align-items-center">
								...
								<div class="tp-process-item-content">
									...
									<p>Want the flexibility of an everyday account with the interest of a term deposit? The Cash
										Management Account is for you!</p>
								</div>
							</div>
						</div>
					</div>
					<div class="col-lg-6">
						<div class="tp-process-thumb-wrapper p-relative wow fadeInRight" data-wow-duration="1s"
							...
							<div class="tp-process-thumb p-relative">
								...
								<img class="shape-1" src="uss-modules/uss-bank/bank-home/assets/img/process/img-2.jpg" alt="">
							</div>
							<div class="tp-process-counter d-flex align-items-center">
								...
								<div class="tp-process-content">
									<h4 class="tp-process-counter-title"><span class="purecounter" data-purecounter-duration="3"
											data-purecounter-end="38"></span>k+</h4>
					...
					<div class="col-lg-5">
						<div class="tp-faq-wrapper">
							<div class="tp-faq-title-wrapper">
								...
								<p>Open a new account. You can call us on to do this for you, or get started now. Alternatively
									you can visit us in any branch.
							...
							<div class="tp-faq-counter-wrapper d-flex">
								<div class="tp-faq-counter d-flex align-items-center mr-20 mb-30">
									...
									<div class="tp-faq-counter-content">
										<h4 class="tp-faq-counter-title"><span class="purecounter" data-purecounter-duration="3"
												data-purecounter-end="17"></span></h4>
										<p>Banking Awards</p>
									</div>
								</div>
								<div class="tp-faq-counter d-flex align-items-center mb-30">
									...
									<div class="tp-faq-counter-content">
										<h4 class="tp-faq-counter-title"><span class="purecounter" data-purecounter-duration="2"
												data-purecounter-end="353"></span>+</h4>
							...
							<div class="accordion" id="general_accordion">
								<div class="accordion-item tp-faq-active">
									...
									<div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne"
										...
										<div class="accordion-body">
											<p>WE SUGGEST YOU: <br>Modernize your business and prepare for the transition to the
												new digital age. Raise funds on attractive terms to finance investments in
												electronic systems that contribute to the digital transformation of your business.
											</p>
										</div>
									</div>
								</div>
								...
								<div class="accordion-item">
									...
									<div id="collapseThree" class="accordion-collapse collapse" aria-labelledby="headingThree"
										data-bs-parent="#general_accordion">
										<div class="accordion-body">
											<p>WE SUGGEST YOU: <br> Expand your business activities across borders and increase
												your extroversion. Secure a loan with preferential terms to develop your exports or
												modernize your tourism activity.</p>
										</div>
									</div>
								</div>
								<div class="accordion-item">
									...
									<div id="collapseFour" class="accordion-collapse collapse" aria-labelledby="headingFour"
										data-bs-parent="#general_accordion">
										<div class="accordion-body">
											<p>WE SUGGEST YOU: <br>Strengthen the innovative action of your business with a TAA
												loan. Invest in creating new products and services, improving production methods or
												patenting.</p>
										</div>
									</div>
								</div>
