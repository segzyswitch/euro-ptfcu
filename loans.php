					...
					<div class="col-lg-8">
						<div class="tp-service-details-wrapper">
							...
							<p>If you are ready to purchase an automobile or truck, whether new or used, we are ready to finance the
								vehicle for you. We have competitive interest rates and terms on auto loans.</p>

							<p>If you have been considering a recreational vehicle, motor home, boat or other leisure vehicle, we can
							...
							<div class="tp-service-details-box-2 d-flex mb-40">
								<div class="tp-service-details-box-content mr-30">
									...
									<p> loans can serve various purposes, such as funding personal expenses, purchasing a home (mortgage
										loan), buying a car (auto loan), financing education (student loan), or supporting business
										operations (business loan).</p>
									<p>Borrowers typically need to submit an application to the bank, providing information about their
										financial situation, credit history, and the purpose of the loan. The bank evaluates the application
										and, if approved, determines the terms and conditions of the loan.</p>
								</div>
