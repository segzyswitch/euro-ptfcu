...
<head>
    ...
    <title>Resume Transactions - PartnersTrust FCU </title>
     ...
     <header class="header navbar navbar-expand-sm">
         ...
         <ul class="navbar-item theme-brand flex-row  text-center">
             <li class="nav-item theme-logo">
                 <a href="/">
                     <img src="https://demofederal.dirtyscripts.shop/ui/assets/img/logo.svg" class="navbar-logo" alt="logo">
                 </a>
             </li>
         ...
         <ul class="navbar-item flex-row ml-md-auto">
             ...
             <li class="nav-item dropdown language-dropdown">
                 <a href="javascript:void(0);" class="nav-link dropdown-toggle" id="language-dropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                     <img src="https://demofederal.dirtyscripts.shop/ui/assets/img/de.png" class="flag-width" alt="flag">
                 </a>
                 <div class="dropdown-menu position-absolute" aria-labelledby="language-dropdown">
                     <a class="dropdown-item d-flex" href="#" data-lang="German" value="German"><img src="https://demofederal.dirtyscripts.shop/ui/assets/img/ca.png" class="flag-width" alt="flag"> <span class="align-self-center">&nbsp;German</span></a>
                     <a class="dropdown-item d-flex" href="javascript:void(0);"><img src="https://demofederal.dirtyscripts.shop/ui/assets/img/jp.png" class="flag-width" alt="flag"> <span class="align-self-center">&nbsp;Japanese</span></a>
                     <a class="dropdown-item d-flex" href="javascript:void(0);"><img src="https://demofederal.dirtyscripts.shop/ui/assets/img/fr.png" class="flag-width" alt="flag"> <span class="align-self-center">&nbsp;French</span></a>
                     <a class="dropdown-item d-flex" href="javascript:void(0);"><img src="https://demofederal.dirtyscripts.shop/ui/assets/img/ca.png" class="flag-width" alt="flag"> <span class="align-self-center">&nbsp;English</span></a>
                 </div>
             </li>
                                 ...
                                 <div class="media">
                                     ...
                                     <div class="media-body">
                                         <div class="">
                                             ...
                                             <p class="msg-title">2024-07-06 10:23:28</p>
                                         </div>
                                     </div>
                                 </div>
                             ...
                             <div class="">
                                 ...
                                 <div class="media">
                                     ...
                                     <div class="media-body">
                                         <div class="">
                                             <h5 class="usr-name">Login into dashboard</h5>
                                             <p class="msg-title">2024-07-06 10:06:41</p>
                                         </div>
                                     </div>
                                 </div>
                             ...
                             <div class="">
                                 ...
                                 <div class="media">
                                     ...
                                     <div class="media-body">
                                         <div class="">
                                             <h5 class="usr-name">Login into dashboard</h5>
                                             <p class="msg-title">2024-07-06 10:06:39</p>
                                         </div>
                                     </div>
                                 </div>
                     ...
                     <div class="notification-scroll">
                         ...
                         <div class="dropdown-item">
                             <div class="media server-log">
                                 ...
                                 <div class="media-body">
                                     <div class="data-info">
                                         <h6 class="">Crypto Deposit</h6>
                                         <p class="">2024-07-02 19:13:14</p>
                                     </div>
             ...
             <li class="nav-item dropdown user-profile-dropdown">
                 <a href="javascript:void(0);" class="nav-link dropdown-toggle user" id="userProfileDropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="true">
                     <img src="https://demofederal.dirtyscripts.shop/ui/assets/img/user.png" alt="avatar" class="img-fluid">
                 </a>
                    ...
                    <div class="page-header">
                        ...
                        <nav class="breadcrumb-one" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page"><span>Resume Transactions</span></li>
                            </ol>
                        </nav>
            ...
            <div class="col-lg-12 layout-spacing">
                ...
                <div class="task-list-section">
                        ...
                        <div data-section="s-new" class="task-list-container" data-connect="sorting">
                            <div class="connect-sorting">
                                <div class="task-container-header">
                                    <h6 class="s-heading" data-listTitle="In Progress">In Progress <span class="text-danger">#40</span></h6>
                                </div>
                                    ...
                                    <div data-draggable="true" class="card img-task" style="">
                                        <div class="card-body">
                                            ...
                                            <div class="task-header">
                                                <div class="">
                                                    <h4 class="" data-taskTitle="Creating a new Portfolio on Dribble">Wire transfer info <br> <br></h4>
                                                    <p>Amount: $5,553.00<br>
                                                        Bank Name: Ifhsnfn jtdgg<br>
                                                        Account No: 035670355<br>
                                                        Refrence ID: 6687adf00b32a
                                ...
                                <div class="add-s-task">
                                    <a href="delete-pending.php?id=6687adf00b32a" class="text-danger">Delete Transaction</a>
                                </div>
                        ...
                        <div data-section="s-new" class="task-list-container" data-connect="sorting">
                            <div class="connect-sorting">
                                <div class="task-container-header">
                                    <h6 class="s-heading" data-listTitle="In Progress">In Progress <span class="text-danger">#37</span></h6>
                                </div>
                                    ...
                                    <div data-draggable="true" class="card img-task" style="">
                                        <div class="card-body">
                                            ...
                                            <div class="task-header">
                                                <div class="">
                                                    <h4 class="" data-taskTitle="Creating a new Portfolio on Dribble">Wire transfer info <br> <br></h4>
                                                    <p>Amount: $1,000.00<br>
                                                        Bank Name: Chase bank<br>
                                                        Account No: 2321233232<br>
                                                        Refrence ID: 6683faf11f1e9
                                ...
                                <div class="add-s-task">
                                    <a href="delete-pending.php?id=6683faf11f1e9" class="text-danger">Delete Transaction</a>
                                </div>
...
<script src="https://demofederal.dirtyscripts.shop/ui/plugins/jquery-ui/jquery-ui.min.js"></script>
...
<script src="https://demofederal.dirtyscripts.shop/assets/js/custom.js"></script>
<!-- END GLOBAL MANDATORY SCRIPTS -->

<!-- BEGIN PAGE LEVEL SCRIPTS -->
<script src="https://demofederal.dirtyscripts.shop/ui/assets/js/ie11fix/fn.fix-padStart.js"></script>
